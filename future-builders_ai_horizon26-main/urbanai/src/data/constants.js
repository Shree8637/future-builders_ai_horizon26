...
export const TEAM = [
  { name: 'Aryan Mehta', role: 'ML Engineer', emoji: '👨‍💻', focus: 'LSTM Architecture & Training' },
  { name: 'Priya Sharma', role: 'Backend Dev', emoji: '👩‍💻', focus: 'API & Real-time Systems' },
  { name: 'Rohan Patel', role: 'Data Scientist', emoji: '👨‍🔬', focus: 'Data Pipeline & Analysis' },
  { name: 'Sneha Iyer', role: 'UI/UX Designer', emoji: '👩‍🎨', focus: 'Design System & Frontend' },
]
